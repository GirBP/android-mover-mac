...
/// Клікабельні компоненти шляху замість дефолтного текстового поля. Кожен компонент —
...
struct BreadcrumbBar: View {
    ...
    /// самий обхід комбінуючих символів, що вже є в RemotePath.pathComponents.
    ...
    var body: some View {
        HStack(spacing: 4) {
            ...
            // Явна кнопка редагування — клік у порожнє місце рядка лишається, але це
            // невидима зона; олівець видимий, доступний з клавіатури і для VoiceOver.
            Button {
                onEditRequested()
            } label: {
